 ...
 *
 */
public final class Image2Ascii {
	boolean negative;
	...
	public Image2Ascii(final boolean negative) {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				fileChooser.setFileFilter(new FileNameExtensionFilter("Images", "jpg", "gif", "png", "jpeg"));
				while (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
					try {
						...
						final String ascii = new Image2Ascii().convert(image);
						...
						final JDialog dialog = new JOptionPane(new JScrollPane(textArea), JOptionPane.PLAIN_MESSAGE).createDialog(Image2Ascii.class.getName());
